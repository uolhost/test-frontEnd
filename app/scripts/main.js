...
// Busca imagem de acordo com o tipo da descrição do status
function getImage(type, description) {
    ...
    return '<div id="painel"><p><img src="images/status-' + color + '.png" alt="Painel Compartilhado">' + description + '</p></div>';
